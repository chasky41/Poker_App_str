...
class MedianMode(VotingMode):
    ...
    def calculate_result(self, votes: Dict[str, any], round_number: int) -> Tuple[bool, Optional[float]]:
        ...
        # Tours suivants : calcul de la médiane
        ...
        closest_value = min(fibonacci_values, key=lambda x: abs(x - median))
